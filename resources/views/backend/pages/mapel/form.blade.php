                                    ...
                                    <form class="form-horizontal" action="{{ route($url, $mapel->mapel_id ?? null) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control @error('mapel_kategori') {{ 'is-invalid' }} @enderror" name="mapel_kategori" id="mapel_kategori" value="{{ old('mapel_kategori') ?? $mapel->mapel_kategori ?? '' }}">
                                                @error('mapel_kategori')
