                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><a class="btn btn-primary btn-sm text-white" href="{{ route('kategori-soal.create') }}"><i class="fa fa-plus"></i> Add</a></h3>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped example1">
                                        ...
                                        <tbody>
                                            @foreach($kategori_soal as $no => $ktg)
                                            <tr>
                                                <td>{{ $no+1 }}</td>
